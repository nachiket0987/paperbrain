...
export const APP_CONFIG = {
  name: "PaperBrain",
  description:
    "AI-Powered PDF Intelligence — Chat with any document using RAG, real-time streaming, and a 7-agent pipeline",
...
export const SOCIAL_LINKS = {
  github: "https://github.com/nachiket0987",
  repository:
    "https://github.com/nachiket0987/paperbrain",
  linkedin: "https://linkedin.com/in/nachiket-gadilohar-profile/",
  twitter: "https://x.com/nachiket0987",
} as const;
